...
const CategoryPage = async ({params}: {params: {category: string}}) => {
    const data: simplifiedProduct[] = await FetchProducts(params.category)
    return (
        <div className="mt-36">
            <div className="mx-auto maw-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="flex justify-between items-center">
                    <h1 className="text-2xl font-bold tracking-tight text-gray-200">Our Products for {params.category}</h1>
                </div>
