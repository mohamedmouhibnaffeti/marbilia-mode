        ...
        <div>
            <div className="mx-auto maw-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                <div className="flex justify-between items-center">
                    ...
                    <Link href="/all" className="text-primary flex items-center gap-x-1 transition delay-200 hover:translate-x-2">
                        ...
                        <div key={product._id} className="group relative bg-slate-900 rounded-b-md">
                            ...
                            <div className="mt-4 flex justify-between p-1">
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-slate-300">{product.categoryName}</p>
                                </div>
                                <p className="text-sm font-md text-slate-300">{product.price} TND</p>
                            </div>
                        </div>
                    )})}
                </div>
